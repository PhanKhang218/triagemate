...
triage_agent = LlmAgent(
    ...
    instruction=(
        ...
        "3. Call assess_vital_signs with the patient's vitals (pass 0 for any not "
        "reported) to get an objective danger-vital check.\n"
        "4. Compare the presentation against the red flags, the ESI criteria, and the "
        "vital-sign assessment. A matched red flag's suggested ESI and the vital "
        "check's 'suggested_min_acuity' are acuity FLOORS — never assign a less "
        "urgent level than the most urgent floor.\n"
        "5. Output a concise draft: suggested ESI level (1-5), the ESI label, matched "
